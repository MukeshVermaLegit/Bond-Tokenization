...
contract BondTokenTest is Test {
    ...
    function test_RedeemAtMaturity() public {
       ...
       // uint256 contractUSDCBefore = usdc.balanceOf(address(bondToken));
        ...
        assertApproxEqAbs(usdc.balanceOf(alice), aliceUSDCBefore + expectedTotal, 10, "Total redemption should be approximately equal");
    ...
    function test_MultipleInterestClaims() public {
        ...
        assertApproxEqAbs(bondToken.claimedInterest(alice), twoMonthsInterest, 1, "Two months interest should be approximately equal");
    }
}